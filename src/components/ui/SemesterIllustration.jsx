      ...
      <div className="relative bg-white border-[3px] border-black rounded-3xl p-6 sm:p-8 md:p-10 lg:p-12 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] overflow-hidden transition-all duration-300 group-hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] group-hover:-translate-y-1">
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between space-y-6">
            ...
            {/* Tactile Bottom Corner Badge & Dot Matrix */}
            <div className="flex items-center gap-4 pt-2">
              <div
                className={`w-12 h-12 ${arrowBg} border-2.5 border-black rounded-xl shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] flex items-center justify-center font-black text-2xl text-black transition-transform duration-200 group-hover:translate-x-1 group-hover:-translate-y-1 group-hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]`}
              >
                ↗
              </div>

              {/* Dot Matrix Pattern */}
              <div className="grid grid-cols-6 gap-1.5 py-1 px-2 border-2 border-dashed border-black/30 rounded-lg">
                {[...Array(18)].map((_, i) => (
                  <span
                    key={i}
                    className="w-1.5 h-1.5 rounded-full bg-black/40 group-hover:bg-black transition-colors"
                  />
                ))}
              </div>
            </div>
