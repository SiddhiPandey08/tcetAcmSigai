  ...
  return (
    ...
    >
      ...
      >
        <div
          data-id={event.eventId}
          className="relative bg-white border-[3px] border-black rounded-3xl overflow-hidden shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all duration-300 hover:shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] group"
        >
...
export default function Events() {
  const eventsStructure = useMemo(() => {
    const grouped = eventsData.reduce((acc, event, index) => {
